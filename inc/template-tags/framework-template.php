...
if ( ! function_exists( 'log_lolla_pro_array_unique_objects' ) ) {
	function log_lolla_pro_uniquecol( $obj ) {
		static $idlist = array();
	...
	function log_lolla_pro_array_unique_objects( $array ) {
		$unique = array_filter( $array, 'log_lolla_pro_uniquecol' );
		return $unique;
	}
}


if ( ! function_exists( 'log_lolla_pro_array_flatten' ) ) {
	/**
	 * Flatten an array
	 *
	 ...
	 */
	function log_lolla_pro_array_flatten( array $array ) {
...
if ( ! function_exists( 'log_lolla_pro_create_sentence_from_arrays' ) ) {
	...
	function log_lolla_pro_create_sentence_from_arrays( $array1, $array2 ) {
		...
		$ret .= esc_html_x( 'This site is about', 'log-lolla-pro-pro' );
		$ret .= ' ';

		$separator = esc_html_x( ', ', 'log-lolla-pro-pro' );
		$connector = esc_html_x( 'and', 'log-lolla-pro-pro' );
...
if ( ! function_exists( 'log_lolla_pro_linear_conversion_of_a_range' ) ) {
	/**
	 ...
	 */
	function log_lolla_pro_linear_conversion_of_a_range( $old_value, $old_min, $old_max, $new_min, $new_max ) {
