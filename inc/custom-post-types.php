...
if ( ! function_exists( 'log_lolla_create_custom_post_type_summary' ) ) {
  /**
   * Create custom post type Summary
   *
   * @link https://codex.wordpress.org/Function_Reference/register_post_type
   */
  function log_lolla_create_custom_post_type_summary() {
    $labels = array(
      'name'               => _x( 'Summaries', 'post type general name', 'log-lolla' ),
  		'singular_name'      => _x( 'Summary', 'post type singular name', 'log-lolla' ),
  		'menu_name'          => _x( 'Summaries', 'admin menu', 'log-lolla' ),
  		'name_admin_bar'     => _x( 'Summary', 'add new on admin bar', 'log-lolla' ),
  		'add_new'            => _x( 'Add New', 'book', 'log-lolla' ),
  		'add_new_item'       => __( 'Add New Summary', 'log-lolla' ),
  		'new_item'           => __( 'New Summary', 'log-lolla' ),
  		'edit_item'          => __( 'Edit Summary', 'log-lolla' ),
  		'view_item'          => __( 'View Summary', 'log-lolla' ),
  		'all_items'          => __( 'All Summaries', 'log-lolla' ),
  		'search_items'       => __( 'Search Summaries', 'log-lolla' ),
  		'parent_item_colon'  => __( 'Parent Summaries:', 'log-lolla' ),
  ...
  add_action( 'init', 'log_lolla_create_custom_post_type_summary' );
}
